...
class ViewPlayer():
    def __init__(self, players):
        ...
        self.label_base_player = ttk.Label(self.window, text="Joueur : ")
        ...
        self.player_list.grid(row=1, column=4, rowspan=7, columnspan=5, padx=5, pady=5)
        # Order by name
        self.b_order_name = ttk.Button(
            self.window,
            text="Trier par nom",
            )
        self.b_order_name.grid(row=0, column=4, padx=5, pady=5)
        # Order by ranking
        self.b_order_rank = ttk.Button(
            self.window,
            text="Trier par classement",
            )
        self.b_order_rank.grid(row=0, column=5, padx=5, pady=5)
        # Save button
        self.button_add = ttk.Button(
            self.window,
            text="Enregistrer les modifications",
            )
        self.button_add.grid(row=7, column=1, columnspan=2, padx=5, pady=5)
        # Quit window
        ...
        self.button_quit.grid(row=7, column=3, padx=5, pady=5)
